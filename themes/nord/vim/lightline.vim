...
let s:p.inactive.left   = [ [ s:color15, s:color0  ], [ s:color7,  s:color0 ], [ s:color7,  s:color0 ] ]

let s:p.normal.middle   = [ [ s:color15, s:color0 ] ]

let s:p.normal.right    = [ [ s:color8,  s:color15 ], [ s:color15, s:color8 ], [ s:color15, s:color0 ] ]
