...
call Themer("CursorLineNR",                 g:color10,    g:color8,     "NONE")
call Themer("LineNr",                       g:color10,    g:color0,     "NONE")
call Themer("multiple_cursors_cursor",      g:none,       g:color11,    "NONE")
call Themer("Normal",                       g:color12,    g:none,       "NONE")
...
call Themer("VertSplit",                    g:background, g:background, "NONE")
...
call Themer("IncSearch",                    g:color0,     g:color3,     "NONE")
call Themer("Search",                       g:color0,     g:color3,     "NONE")

" Completion menu
call Themer("Pmenu",                        g:none,       g:color0,     "NONE")
call Themer("PmenuSel",                     g:none,       g:color8,     "NONE")
...
call Themer("NonText",                      g:color0,     g:background, "NONE")
call Themer("Visual",                       g:color3,     g:color0,     "NONE")
call Themer("Todo",                         g:color3,     g:none,       "NONE")
...
call Themer("SpecialKey",                   g:foreground, g:color0,     "NONE")
...
call Themer("DiffText",                     g:color3,     g:color0,     "NONE")

" Types
call Themer("Boolean",                      g:color4,     g:none,       "NONE")
call Themer("Character",                    g:color2,     g:none,       "NONE")
call Themer("Constant",                     g:color6,     g:none,       "italic")
call Themer("Float",                        g:color5,     g:none,       "NONE")
call Themer("Function",                     g:color4,     g:none,       "NONE")
call Themer("Identifier",                   g:color4,    g:none,       "NONE")
call Themer("Number",                       g:color5,     g:none,       "NONE")
call Themer("String",                       g:color6,     g:none,       "NONE")

" Language constructs
call Themer("Comment",                      g:color10,    g:none,       "NONE")
call Themer("Conditional",                  g:color2,     g:none,       "NONE")
call Themer("Debug",                        g:color4,     g:none,       "NONE")
call Themer("Delimiter",                    g:color1,     g:none,       "NONE")
call Themer("Exception",                    g:color4,     g:none,       "NONE")
call Themer("Keyword",                      g:color4,     g:none,       "NONE")
call Themer("Noise",                        g:color1,     g:none,       "NONE")
call Themer("Label",                        g:color11,    g:none,       "NONE")
call Themer("Operator",                     g:color2,     g:none,       "NONE")
call Themer("Repeat",                       g:color4,     g:none,       "NONE")
call Themer("Special",                      g:color1,     g:none,       "NONE")
call Themer("SpecialChar",                  g:color1,     g:none,       "NONE")
call Themer("SpecialComment",               g:color4,     g:none,       "NONE")
call Themer("Statement",                    g:color2,     g:none,       "NONE")
call Themer("Tag",                          g:color1,     g:none,       "NONE")

" CtrpP
call Themer("CtrlPMatch",                   g:color3,    g:none,       "NONE")

" Neomake
call Themer("NeomakeWarning",               g:color3,     g:color0,     "NONE")
...
call Themer("PreProc",                      g:color1,     g:none,       "NONE")
call Themer("StorageClass",                 g:color14,    g:none,       "NONE")
call Themer("Type",                         g:color3,     g:none,       "NONE")
...
"call Themer("jsFuncCall",                   g:color4,     g:none,       "NONE")
...
"call Themer("phpOperator",                  g:color2,     g:none,       "NONE")
...
" Vim
call Themer("vimCommand",                   g:color3,     g:none,       "NONE")
call Themer("vimUserFunc",                  g:color4,     g:none,       "NONE")
